<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChiTietThanhToanTamUng_Mar_Update.ascx.cs"
    Inherits="Controls_ChiTietThanhToanTamUng_Mar_Update" %>
...
//                InputThanhToanConLai_ByMaChiPhi.set_value(rnTamUngConLai_ByMaChiPhiAn.get_value() - rdThanhTien.get_value() * rnTiGia.get_value());
             ...
             if (txtMaCP_CT.get_textBoxValue() != "") {
                 ...
                 InputTienChiTietConLai.set_value(rnTienChiTietConLaiAn.get_value() + rnTienThanhToanConLai.get_value() - rnSoTienThanhToan.get_value());
             }
        ...
        function onkeyUpEvent2() {
            ...
            InputThanhToanConLai_ByMaChiPhi.set_value(rnTamUngConLai_ByMaChiPhiAn.get_value() + (rdThanhTienAn.get_value() - rdSoTienThanhToan.get_value()));
            ...
            if (rnTamUngConLai.get_value() < 0) {
             ...
             if (txtMaCP_CT.get_textBoxValue() != "") {
                 ...
                 InputTienChiTietConLai.set_value(rnTienChiTietConLaiAn.get_value() + rdThanhTienAn.get_value() - rdSoTienThanhToan.get_value());
             }
        }
        ...
        <tr>
            ...
            <td align="left">
                <telerik:RadNumericTextBox ID="rnTamUngConLaiCuaMaChiPhi" runat="server" AutoPostBack="false"
                    ReadOnly="True" Width="160px" Enabled="False">
                </telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            ...
            <td align="left">
             <%--   <asp:TextBox ID="txtMaCP_CT" runat="server" Enabled="False" Width="155px" Text='<%#Eval("MaCP_CT") %>'></asp:TextBox>--%>
             <telerik:RadTextBox ID="txtMaCP_CT" runat="server" Width="160px" Enabled="false"
                Text='<%# Eval("MaCP_CT") %>'>
            </telerik:RadTextBox>
            </td>
            <td width="10">
        ...
        <tr>
            ...
            <td align="left">
                <telerik:RadNumericTextBox ID="rnSoTienThanhToan" runat="server" AutoPostBack="false"
                    Width="160px" Value="0" onkeyup="onkeyupEvent()" MinValue="0">
                </telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtLoaiTien" runat="server" Enabled="False" Width="155px" Text='<%#Eval("LoaiTien") %>'></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txtSoHoaDon" runat="server" Width="155px" Enabled="true" Text='<%#Eval("SoHoaDon") %>'></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
            ...
            <td align="left">
                <asp:TextBox ID="txtDVT" runat="server" Enabled="true" Width="155px" Text='<%#Eval("DVT") %>'></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
