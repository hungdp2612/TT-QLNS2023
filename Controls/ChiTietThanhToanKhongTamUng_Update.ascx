<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChiTietThanhToanKhongTamUng_Update.ascx.cs"
    Inherits="Controls_ChiTietThanhToanKhongTamUng_Update" %>
...
<table cellpadding="2" cellspacing="2">
    ...
    <tr>
        ...
        <td align="left">
            <telerik:RadNumericTextBox ID="rdThanhTien" Enabled="true" runat="server" AutoPostBack="false" Width="165px"
    ...
    <tr>
        ...
        <td align="left">
            <telerik:RadNumericTextBox ID="rnSoLuong" runat="server" Width="165px" Enabled="true"
                Value="0"  AutoPostBack="true" OnTextChanged="rdThanhTien_TextChanged">
            </telerik:RadNumericTextBox>
        </td>
        <td>
            &nbsp;
