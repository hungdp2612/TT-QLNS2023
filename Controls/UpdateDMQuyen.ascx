<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UpdateDMQuyen.ascx.cs" Inherits="Controls_UpdateDMQuyen" %>
<style type="text/css">
    .Rong
    {
        width: 100px;
...
<div style="margin-left: 20px">
    <table border="0" cellpadding="2" cellspacing="2">
        <tr>
            ...
            <td>
                <asp:TextBox ID="tbIDQuyen" runat="server" Width="185px" Text='<%# Bind( "IDQuyen") %>'></asp:TextBox>
                <asp:HiddenField ID="hdIDQuyen" runat="server" Value='<%# Bind( "IDQuyen") %>' />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="tbTenQuyen" runat="server" Width="185px" Text='<%# Bind( "Quyen") %>'></asp:TextBox>
        ...
        <tr>
            <td colspan="3">
                <asp:ImageButton ID="btLuu" runat="server" ImageUrl="~/Images/Nutchuanweb/luu.png" ValidationGroup="Gedit"
                    CommandName="Update" />
