<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChiTietPhieuTamUng_Mar_Update.ascx.cs"
    Inherits="Controls_ChiTietPhieuTamUng_Mar_Update" %>
    ...
    <script type="text/javascript" defer="defer" language="javascript">
        function onkeyupEvent() {
            ...
            if (txtMaCP_CT.get_textBoxValue() != "") {
                ...
                InputTienChiTietConLai.set_value(rnTienChiTietConLaiAn.get_value() + (rdThanhTien.get_value() * rnTiGia.get_value() - UCrdSoTien.get_value() * rnTiGia.get_value()));
            }
        }
...
<div style="float: left; margin-left: 20px">
    <table cellpadding="2" cellspacing="2">
        ...
        <tr>
            ...
            <td align="left">
                <telerik:RadTextBox ID="txtMaCP_CT" runat="server" Width="155px" Enabled="false"
                    Text='<%# Eval("MaCP_CT") %>'>
                </telerik:RadTextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td align="left" colspan="5">
                <asp:TextBox ID="UCtxtLyDo" runat="server" Height="25px" Width="99%" Text='<%# Eval("LyDo") %>'></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:TextBox ID="txtNam" runat="server" Width="150px" Text='<%# Eval("Nam") %>' Visible="false"></asp:TextBox>
                <asp:TextBox ID="txtThang" runat="server" Width="150px" Text='<%# Eval("Thang") %>'
        ...
        <tr>
            <td>
                <telerik:RadNumericTextBox ID="rnTienChiTietConLaiAn" runat="server" ReadOnly="True"
                    Width="160px" Enabled="false" Display="false" Value="0">
                </telerik:RadNumericTextBox>
            </td>
        </tr>
    </table>
