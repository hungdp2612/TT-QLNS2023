<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true"
    CodeFile="Tonghopbosungngansach.aspx.cs" Inherits="Baocao_Tonghopbosungngansach" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="bgtieudebox">
                            <center>
                                BÁO CÁO TỔNG HỢP BỔ SUNG NGÂN SÁCH
                            </center>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="tbBoPhan" runat="server" Enabled="False" Width="170px">
                                        </asp:TextBox>
                                    </td>
                                    <td style="width: 10">
                                        &nbsp;
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="tbBoPhanNhan" runat="server" Enabled="False" Width="170px">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="tbChucVu" runat="server" Enabled="False" Width="170px">
                                        </asp:TextBox>
                                    </td>
                                    <td style="width: 10">
                                        &nbsp;
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="tbChucVuNhan" runat="server" Enabled="False" Width="170px">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
            ...
            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="MultiPage" ReorderTabsOnSelect="True"
                ...
                <Tabs>
                    ...
                    <telerik:RadTab runat="server" Text="Xuất excel KDND">
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
                                ...
                                <MasterTableView ShowGroupFooter="true">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="BTGD" FilterControlAltText="Filter BTGD column"
                                            HeaderText="BTGĐ" UniqueName="BTGD" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                    ...
                                    <GroupByExpressions>
                                        <telerik:GridGroupByExpression>
                                            ...
                                            <GroupByFields>
                                                <telerik:GridGroupByField FieldName="DienGiaiNhomNS" HeaderText="Nội dung" />
                                            </GroupByFields>
                                        </telerik:GridGroupByExpression>
                                    </GroupByExpressions>
                                    <EditFormSettings>
                ...
                <telerik:RadPageView ID="RadPageView2" runat="server">
                    <center>
                        <table>
                            <tr>
                                <td align="center">
                                    <asp:ImageButton ID="btXem2" runat="server" ImageUrl="~/images/Nutchuanweb/btXem.png"
                                        OnClick="btXem2_Click" ValidationGroup="gIn" />
                                    &nbsp;
                                    <asp:ImageButton ID="btExcel2" runat="server" ImageUrl="~/images/Nutchuanweb/excell.png"
                                        OnClick="btExcel2_Click" ValidationGroup="gIn" />
                                </td>
                            </tr>
                        </table>
                        <div style="overflow: scroll; width: 1000px; height: 500px">
                            <telerik:RadGrid ID="RG2" runat="server" AutoGenerateColumns="False" CellSpacing="0"
                                GridLines="Both" ShowGroupFooter="true">
                                <HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default">
                                </HeaderContextMenu>
                                <MasterTableView ShowGroupFooter="true">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="TTMD" FilterControlAltText="Filter TTMD column"
                                            HeaderText="TTMD" UniqueName="TTMD" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <FooterStyle Font-Bold="True" ForeColor="Blue" />
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="PB27" FilterControlAltText="Filter PB27 column"
                                            HeaderText="PB27" UniqueName="PB27" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="PB28" FilterControlAltText="Filter PB28 column"
                                            HeaderText="PB28" UniqueName="PB28" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="BHSM" FilterControlAltText="Filter BHSM column"
                                            HeaderText="BHSM" UniqueName="BHSM" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <FooterStyle Font-Bold="True" ForeColor="Blue" />
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="PB30" FilterControlAltText="Filter PB30 column"
                                            HeaderText="PB30" UniqueName="PB30" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="PB31" FilterControlAltText="Filter PB31 column"
                                            HeaderText="PB31" UniqueName="PB31" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="SR_HBT" FilterControlAltText="Filter SR_HBT column"
                                            HeaderText="SR_HBT" UniqueName="SR_HBT" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <FooterStyle Font-Bold="True" ForeColor="Blue" />
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="SR_LVS" FilterControlAltText="Filter SR_LVS column"
                                            HeaderText="SR_LVS" UniqueName="SR_LVS" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="SR_NOANH" FilterControlAltText="Filter SR_NOANH column"
                                            HeaderText="SR_NOANH" UniqueName="SR_NOANH" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="SR_3T2" FilterControlAltText="Filter SR_3T2 column"
                                            HeaderText="SR_3T2" UniqueName="SR_3T2" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="SR_LVV" FilterControlAltText="Filter SR_LVV column"
                                            HeaderText="SR_LVV" UniqueName="SR_LVV" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="SR_LQD" FilterControlAltText="Filter SR_LQD column"
                                            HeaderText="SR_LQD" UniqueName="SR_LQD" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CNL" FilterControlAltText="Filter CNL column"
                                            HeaderText="CNL" UniqueName="CNL" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="BHLD" FilterControlAltText="Filter BHLD column"
                                            HeaderText="BHLD" UniqueName="BHLD" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CNS" FilterControlAltText="Filter CNS column"
                                            HeaderText="CNS" UniqueName="CNS" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="SKL" FilterControlAltText="Filter SKL column"
                                            HeaderText="SKL" UniqueName="SKL" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CONGSO" FilterControlAltText="Filter CONGSO column"
                                            HeaderText="CONGSO" UniqueName="CONGSO" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CS2" FilterControlAltText="Filter CS2 column"
                                            HeaderText="CS2" UniqueName="CS2" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CN_HNO" FilterControlAltText="Filter CN_HNO column"
                                            HeaderText="CN_HNO" UniqueName="CN_HNO" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CN_DNA" FilterControlAltText="Filter CN_DNA column"
                                            HeaderText="CN_DNA" UniqueName="CN_DNA" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="CN_CTO" FilterControlAltText="Filter CN_CTO column"
                                            HeaderText="CN_CTO" UniqueName="CN_CTO" DataFormatString="{0:0,0}" FooterAggregateFormatString="{0:0,0}"
                                            Aggregate="Sum">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                        </telerik:GridBoundColumn>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btExcel2" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
