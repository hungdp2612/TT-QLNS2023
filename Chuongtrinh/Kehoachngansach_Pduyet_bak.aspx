<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true"
    CodeFile="Kehoachngansach_Pduyet_bak.aspx.cs" Inherits="Chuongtrinh_Kehoachngansach_Pduyet_bak" %>
                        ...
                        <telerik:RadGrid ID="RG_XemNS" runat="server" AllowAutomaticDeletes="True" AllowAutomaticUpdates="True"
                            ...
                            <MasterTableView>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="THÁNG" UniqueName="Thang" DataField="Thang"
                                        AllowFiltering="false" FilterControlWidth="50px" CurrentFilterFunction="Contains"
                ...
                <telerik:RadPageView ID="RadPageView3" runat="server">
                        ...
                        <center>
                            <table cellpadding="1" cellspacing="0" style="margin-top: 10px; margin-bottom: 10px;">
                                <tr>
                                    ...
                                    <td align="left">
                                        <telerik:RadNumericTextBox ID="rnQui_HieuChinh" runat="server" Width="70px" AutoPostBack="True"
                                            Skin="Windows7" MaxValue="4" MinValue="1" Enabled="false">
                                            <NumberFormat ZeroPattern="n" DecimalDigits="0" GroupSeparator=""></NumberFormat>
                                        </telerik:RadNumericTextBox>
                                    </td>
                                    <td width="5px">
                    ...
                    <fieldset style="margin-left: 5px; width: 970px;">
                        ...
                        <telerik:RadGrid ID="RG_HieuChinh" runat="server" AllowAutomaticDeletes="True" AllowAutomaticUpdates="True"
                            Skin="Windows7" AllowMultiRowEdit="True" AllowAutomaticInserts="True" GridLines="None"
                            AutoGenerateColumns="False" AllowFilteringByColumn="true" ShowFooter="true" OnDeleteCommand="RG_HieuChinh_DeleteCommand"
                            OnItemCommand="RG_HieuChinh_ItemCommand" OnUpdateCommand="RG_HieuChinh_UpdateCommand"
                            OnCancelCommand="RG_HieuChinh_CancelCommand">
                            <GroupingSettings CaseSensitive="False" />
                            <ClientSettings EnableRowHoverStyle="false">
                                <Selecting AllowRowSelect="false" />
                                <Scrolling AllowScroll="True" UseStaticHeaders="True" />
