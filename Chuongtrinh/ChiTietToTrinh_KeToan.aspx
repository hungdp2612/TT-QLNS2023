<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietToTrinh_KeToan.aspx.cs"
    Inherits="ChiTietToTrinh_KeToan" %>
                    ...
                    <ContentTemplate>
                        <center>
                            ...
                            <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                                <ProgressTemplate>
                                    <img alt="Loading..." src="../image/ajax-loader-bar.gif" /></ProgressTemplate>
                            </asp:UpdateProgress>
                        </center>
                    </ContentTemplate>
                    ...
                    <center>
                        <table>
                            <tr>
                                ...
                                <td align="left">
                                    <telerik:RadComboBox ID="cbMaSoChiPhi" runat="server" Width="160px" DataTextField="MSCHIPHI" Skin="Windows7"
                                        ...
                                        OnSelectedIndexChanged="cbMaSoChiPhi_SelectedIndexChanged">
                                        <HeaderTemplate>
                                            <table>
                                                <tr>
                                                    <td width="150px">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtMaDV" runat="server" Enabled="false" Width="155px" Visible="false" Skin="Windows7"></asp:TextBox>
                                    <asp:DropDownList ID="cboMaBP" DataTextField="TenGoi" DataValueField="MaBP" runat="server"
                                        Width="160px" Enabled="true" Visible="false" OnSelectedIndexChanged="cboMaBP_SelectedIndexChanged"
                                        AutoPostBack="true">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 10px">
                                ...
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="tbLoaiTien"
                                        Display="Dynamic" ErrorMessage=" Không lấy được loại tiền." SetFocusOnError="True"
                                        ValidationGroup="gLuu">*</asp:RequiredFieldValidator>
                                </td>
                                <td style="width: 10px">
                                </td>
                            </tr>
                    ...
                    <telerik:RadGrid ID="RG" Width="100%" runat="server" AutoGenerateColumns="False" Skin="Windows7"
                        ...
                        <MasterTableView CommandItemDisplay="None">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="MÃ ĐV" UniqueName="MaDV" DataField="MaDV"
