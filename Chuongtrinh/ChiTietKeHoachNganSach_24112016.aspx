<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietKeHoachNganSach_24112016.aspx.cs"
    Inherits="ChiTietKeHoachNganSach_24112016" %>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlDonVi" runat="server" Width="150px" DataTextField="TenDonVi"
                                        Skin="Windows7" DataValueField="MaDonVi" AutoPostBack="false">
                                    </asp:DropDownList>
                                </td>
                                <td width="5px">
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="10">
                                    <telerik:RadTextBox ID="txtGhichu" runat="server" Width="97%" Skin="Windows7">
                                    </telerik:RadTextBox>
                                </td>
                                <td width="5px">
                                </td>
                    ...
                    <telerik:RadGrid ID="RG" Width="100%" runat="server" AutoGenerateColumns="False"
                        ...
                        <MasterTableView CommandItemDisplay="None">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Sotien" UniqueName="Sotien" DataField="Sotien"
                                    FilterControlWidth="50px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                ...
                                <telerik:GridBoundColumn HeaderText="NGÂN SÁCH" UniqueName="SOTIENDV" DataField="SOTIENDV"
                                    FilterControlWidth="50px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                    AutoPostBackOnFilter="true" DataFormatString="{0:###,###.##}" AllowFiltering="false">
                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="90px" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="90px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="NS UQ" UniqueName="SOTIENUQ" DataField="SOTIENUQ"
                                    FilterControlWidth="50px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                    AutoPostBackOnFilter="true" DataFormatString="{0:###,###.##}" AllowFiltering="false">
                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="90px" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="90px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="ĐV NHẬN UQ" UniqueName="MaDVNhanUQ" DataField="MaDVNhanUQ"
                                    FilterControlWidth="50px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                    AutoPostBackOnFilter="true" AllowFiltering="false">
                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="90px" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="90px" />
                                ...
                                <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn3 column"
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/images/edit.png" Visible='<%#(!Convert.ToBoolean(Eval("TICHUQ"))) %>'
                                            CommandName="Edit" />
                                    </ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" HeaderText="XÓA"
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnDelete" OnClientClick="return fConfirm('Bạn chắc muốn xóa nhóm này?')"
                                            ImageUrl="~/images/xoa.gif" CommandName="Delete" runat="server" Visible='<%#(!Convert.ToBoolean(Eval("TICHUQ"))) %>' />
                                    </ItemTemplate>
                    ...
                    <div style="float: left; width: 45%">
                        <fieldset>
                            <legend style="font-size: 9pt; font-family: Tahoma; color: #982849; text-align: left">
                                1. Ngân sách tháng trước</legend>
                            <center>
                                <table width="100%">
                                    <tr>
                                        <td align="right">
