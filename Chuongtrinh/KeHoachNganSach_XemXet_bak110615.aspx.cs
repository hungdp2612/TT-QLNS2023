...
public partial class Chuongtrinh_KeHoachNganSach_XemXet_bak110615 : clsPhanQuyenCaoCap
{
    clsObj Obj;
    ...
    void FLoadChiTietNS()
    {
        ...
        try
        {
            provider.CommandText = "sp_KeHoachNganSach_XemXet_LoadNS";

            provider.CommandType = CommandType.StoredProcedure;

            provider.ParameterCollection = new string[] { "@Nam", "@MaDV", "@Qui" };
            provider.ValueCollection = new object[] {  rnNam.Text, TxtMaDV.Text, rnQui.Text };
