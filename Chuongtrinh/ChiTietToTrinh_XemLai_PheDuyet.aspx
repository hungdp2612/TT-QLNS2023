<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietToTrinh_XemLai_PheDuyet.aspx.cs"
    Inherits="ChiTietToTrinh_XemLai_PheDuyet" %>
...
<body>
    ...
    <div>
        <div style="float: left; margin-left: 20px">
            <asp:TextBox ID="tbSoPhieu" runat="server" Visible="true"></asp:TextBox><asp:HiddenField
                ID="hfPhieuTU" runat="server" />
        </div>
        <center>
            <telerik:RadGrid ID="RGChiTietToTrinh" runat="server" AutoGenerateColumns="False" Skin="Windows7"
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="STiendenghi" FilterControlAltText="Filter STiendenghi column"
                            HeaderText="ST ĐỀ NGHỊ" ReadOnly="True" SortExpression="STiendenghi" UniqueName="STiendenghi"
                          ...
                          <telerik:GridBoundColumn DataField="SoTien" FilterControlAltText="Filter SoTien column"
                            HeaderText="S.TIỀN PD" ReadOnly="True" SortExpression="STiendenghi" UniqueName="SoTien"
                            Aggregate="Sum" ItemStyle-Width="100px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                            AutoPostBackOnFilter="true" FilterControlWidth="100px" DataFormatString="{0:###,###.##}"
                            AllowFiltering="false">
                            <FooterStyle ForeColor="Blue" HorizontalAlign="Left" />
                        ...
                        <telerik:GridBoundColumn HeaderText="GHI CHÚ" UniqueName="GhiChu" DataField="GhiChu"
                          ...
                          <telerik:GridBoundColumn HeaderText="GHI CHÚ BTGĐ" UniqueName="GhichuDuyet" DataField="GhichuDuyet"
                            CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="300px" />
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="300px" />
                        </telerik:GridBoundColumn>
