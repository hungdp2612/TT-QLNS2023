<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietChungTu_KiemTra.aspx.cs"
    Inherits="ChiTietChungTu_KiemTra" %>
...
<body>
    ...
    <div>
        <center>
            <asp:ImageButton ID="btKiemTra" runat="server" ImageUrl="~/images/kiemtra.png" 
                onclick="btKiemTra_Click"/>
            <br />
