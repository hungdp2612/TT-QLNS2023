<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true"
    CodeFile="LapToTrinh_KDND.aspx.cs" Inherits="Chuongtrinh_LapToTrinh_KDND" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function openRadWindowShow(SoToTrinh, madv, Nam, Thang) {
            ...
            var oWnd = manager.open("ChiTietToTrinh_KDND.aspx?SoToTrinh=" + SoToTrinh + "&MaDV=" + madv + "&Nam=" + Nam + "&Thang=" + Thang, "RadWindowManager1");
            oWnd.Center();
        }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <fieldset style="width: 970px; margin-left: 5px">
                <legend style="font-size: 9pt; font-family: Tahoma; color: #982849;">Lập tờ trình</legend>
                <center>
                    <table>
                        <tr>
                            <td align="right">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="cbNguoiPheDuyet"
                                    Display="Dynamic" ErrorMessage="(*)" SetFocusOnError="True" ValidationGroup="GInsert"
                                    ForeColor="Red"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
            ...
            <fieldset style="width: 970px; margin-left: 5px">
                <legend style="font-size: 9pt; font-family: Tahoma; color: #982849;">Danh sách tờ trình</legend>
                <telerik:RadGrid ID="RG" Width="100%" runat="server" AutoGenerateColumns="False"
                    ...
                    PageSize="10" OnCancelCommand="RG_CancelCommand" OnUpdateCommand="RG_UpdateCommand">
                    ...
                    <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="SoToTrinh">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="MÃ DV" UniqueName="MaDV" DataField="MaDV" FilterControlWidth="40px"
                                CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                Visible="false">
                            ...
                            <telerik:GridBoundColumn HeaderText="Người gửi" UniqueName="NguoiGoi" DataField="NguoiGoi"
                                FilterControlWidth="100px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                AutoPostBackOnFilter="true" Visible="false">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="50px" />
