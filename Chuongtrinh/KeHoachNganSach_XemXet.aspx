<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true"
    CodeFile="KeHoachNganSach_XemXet.aspx.cs" Inherits="Chuongtrinh_KeHoachNganSach_XemXet" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" AutoPostBack="true"
                ...
                <Tabs>
                    <telerik:RadTab runat="server" Text="Xem xét kế hoạch ngân sách" Selected="True">
                    </telerik:RadTab>
            ...
            <telerik:RadMultiPage ID="MultiPage" runat="server" Width="100%" SelectedIndex="0"
                ...
                <telerik:RadPageView ID="RadPageView1" runat="server">
                        ...
                        <center>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="cboThang" runat="server" AllowCustomText="true" AutoPostBack="True"
                                            Skin="Windows7" DataTextField="TENTHANG" DataValueField="IDTHANG" Enabled="True"
                                            Filter="Contains" MarkFirstMatch="true" Width="100px" OnSelectedIndexChanged="cboThang_SelectedIndexChanged">
                                        </telerik:RadComboBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="cboThang"
                                            Display="Dynamic" ErrorMessage="(*)" SetFocusOnError="True" ValidationGroup="GInsert"
                                            ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td align="right">
                    ...
                    <fieldset style="width: 970px; margin-left: 5px;">
                        ...
                        <telerik:RadGrid ID="RadGDNganSach" runat="server" Height="360px" Width="100%" AllowFilteringByColumn="True"
                            ...
                            OnPageIndexChanged="RadGDNganSach_PageIndexChanged" OnPageSizeChanged="RadGDNganSach_PageSizeChanged"
                            CellSpacing="0" OnItemCommand="RadGDNganSach_ItemCommand" ShowFooter="True">
                ...
                <telerik:RadPageView ID="RadPageView2" runat="server">
                    <fieldset style="width: 970px; margin-left: 5px;">
                        <legend>Xem kế hoạch ngân sách theo quí</legend>
                        <center>
                            <table>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td align="left">
                                        <telerik:RadNumericTextBox ID="rnNam2" runat="server" Width="70px" AutoPostBack="True"
                                            Skin="Windows7" Enabled="true" OnTextChanged="rnNam2_TextChanged">
                                            <NumberFormat ZeroPattern="n" DecimalDigits="0" GroupSeparator=""></NumberFormat>
                                        </telerik:RadNumericTextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="rnNam"
                                            Display="Dynamic" ErrorMessage="(*)" SetFocusOnError="True" ValidationGroup="GInsert"
                                            ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td align="right">
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="rnQui"
                                            Display="Dynamic" ErrorMessage="(*)" SetFocusOnError="True" ValidationGroup="GInsert2"
                                            ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                        <asp:ImageButton ID="btnExcel2" runat="server" ImageUrl="~/images/Nutchuanweb/excell.png"
                                            ValidationGroup="GInsert2" OnClick="btExcel_Click" />
                                        ...
                                        <asp:ImageButton ID="btnReport" runat="server" ImageUrl="~/images/Nutchuanweb/PrintUyQuyen.png"
                                            ValidationGroup="GInsert2" OnClick="btnReport_Click" />
                                        <asp:ImageButton ID="btnReportPCU" runat="server" ImageUrl="~/images/Nutchuanweb/PrintUyQuyen.png"
                                            ValidationGroup="GInsert2" OnClick="btnReportPCU_Click" />
                                    </td>
                                </tr>
                            </table>
                        </center>
                    ...
                    <fieldset style="width: 970px; margin-left: 5px;">
                        <legend style="">Kế hoạch ngân sách </legend>
                        <telerik:RadGrid ID="RG2" runat="server" Height="360px" Width="100%" AllowFilteringByColumn="True"
                            AllowAutomaticDeletes="True" AllowAutomaticUpdates="True" AllowMultiRowEdit="True"
                            Skin="Windows7" AllowAutomaticInserts="True" GridLines="None" AutoGenerateColumns="False"
                            CellSpacing="0" OnItemCommand="RadGDNganSach_ItemCommand" ShowFooter="True">
                            <GroupingSettings CaseSensitive="False" />
