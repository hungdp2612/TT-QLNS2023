<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true"
    CodeFile="TamUngChuaThanhToan.aspx.cs" Inherits="TamUngChuaThanhToan" %>
        ...
        <ContentTemplate>
            ...
            <div style="float: left; width: 450px; height: 348px">
                <fieldset style="width: 450px">
                    ...
                    <telerik:RadGrid ID="RGNganSach" Width="450px" Height="350px" runat="server" AutoGenerateColumns="False"
                        ...
                        OnSelectedIndexChanged="RGNganSach_SelectedIndexChanged" ShowFooter="true">
                        ...
                        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="MSChiphi"
                            ...
                            <Columns>
                               ...
                               <telerik:GridBoundColumn DataField="NS" FilterControlAltText="Filter NS column"
                                    HeaderText="Số tiền (VND)" ReadOnly="True" SortExpression="NS" UniqueName="SoTien"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                    ...
                                    <FooterStyle Font-Bold="True" ForeColor="Blue" HorizontalAlign="Right" Width="100%" />
                                 ...
                                 <telerik:GridBoundColumn DataField="NSBS" FilterControlAltText="Filter NSBS column"
                                    HeaderText="NS Bổ sung (VND)" ReadOnly="True" SortExpression="NSBS" UniqueName="NSBS"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                    FooterStyle-Font-Bold="true" FooterStyle-ForeColor="Blue" Aggregate="Sum" ItemStyle-Width="100px"
                                    DataFormatString="{0:###,###.##}" AllowFiltering="false">
                                 ...
                                 <telerik:GridBoundColumn DataField="SumNS" FilterControlAltText="Filter SumNS column"
                                    HeaderText="Sum NS (VNĐ)" ReadOnly="True" SortExpression="SumNS" UniqueName="SumNS"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
            ...
            <div style="float: left; width: 500px; margin-left: 25px; height: 160px">
                <fieldset style="width: 500px">
                    <legend>Phiếu TU Chưa thanh toán</legend>
                    <telerik:RadGrid ID="RDPhieuTU" runat="server" Width="500px" Height="158px" AllowPaging="true"
                        ...
                        PageSize="10" OnPageSizeChanged="RDPhieuTU_PageSizeChanged" ShowFooter="true">
                        <GroupingSettings CaseSensitive="False" />
                        <ClientSettings EnableRowHoverStyle="true" EnablePostBackOnRowClick="true">
                        ...
                        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="PhieuTU">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="SoTien" FilterControlAltText="Filter SoTien column"
                                    ...
                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                    DataFormatString="{0:###,###.##}" AllowFiltering="false" FooterStyle-ForeColor="Blue"
                                    Aggregate="Sum">
                                    <FooterStyle Font-Bold="True" ForeColor="Blue" HorizontalAlign="Right" Width="100%" />
                ...
                <fieldset>
                    <legend>Chi tiết phiếu TU chưa thanh toán</legend>
                    <telerik:RadGrid ID="RG" runat="server" Width="500px" Height="158px" AllowPaging="True"
                        AllowFilteringByColumn="True" AllowAutomaticDeletes="True" AllowAutomaticUpdates="True"
                        AllowMultiRowEdit="True" OnPageIndexChanged="RG_PageIndexChanged" OnItemCommand="RG_ItemCommand"
                        Skin="Windows7" OnPageSizeChanged="RG_PageSizeChanged" CellSpacing="0" GridLines="None"
                        ...
                        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Chưa thanh toán" UniqueName="TienConLai" DataField="TienConLai"
