<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietThanhToanTamUng_MAR.aspx.cs"
    Inherits="ChiTietThanhToanTamUng_MAR" %>
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPhieuTU" runat="server" Width="160px" Enabled="false"></asp:TextBox>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtThangNamNS" runat="server" Enabled="False" Width="155px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="left">
                                <telerik:RadComboBox ID="cboMSChiPhi_CT" runat="server" Width="160px" DataTextField="MaCP_CT"
                                    AutoPostBack="True" DataValueField="MaCP_CT" HighlightTemplatedItems="true" EnableLoadOnDemand="true"
                                    Height='150px' DropDownWidth="320px" Enabled="true" OnSelectedIndexChanged="cboMSChiPhi_CT_SelectedIndexChanged">
                                    <HeaderTemplate>
                                        <table width="300px">
                                            <tr>
                                                <td style="width: 100px">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <telerik:RadNumericTextBox ID="rdSoTienThanhToan" runat="server" AutoPostBack="false"
                                    Width="160px" onkeyup="onkeyupEvent()">
                                </telerik:RadNumericTextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSoHoaDon" runat="server" Width="155px" Enabled="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="6">
                                <telerik:RadNumericTextBox ID="rnNganSachConLaiAn" runat="server" AutoPostBack="false"
                                    Display="false" Enabled="false" ReadOnly="True" Value="0" Width="160px">
