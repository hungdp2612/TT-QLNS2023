<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietToTrinh_PheDuyet.aspx.cs"
    Inherits="ChiTietToTrinh_PheDuyet" %>
                        ...
                        <telerik:GridTemplateColumn DataField="GhichuDuyet" HeaderText="GHI CHÚ BTGĐ" UniqueName="GhichuDuyet">
                            <ItemTemplate>
                                <asp:TextBox ID="txtGhiChuDuyet" Text='<%# Eval("GhichuDuyet") %>' runat="server"
                                    Width="280px" AutoPostBack="True" OnTextChanged="txtGhiChuDuyet_TextChanged"></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"  Width="300px"/>
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle"  Width="300px"/>
                        </telerik:GridTemplateColumn>
