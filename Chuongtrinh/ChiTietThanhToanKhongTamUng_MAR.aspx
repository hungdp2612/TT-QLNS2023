<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietThanhToanKhongTamUng_MAR.aspx.cs"
    Inherits="ChiTietThanhToanKhongTamUng_MAR" %>
    ...
    <div>
                ...
                <table cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="5">
                            <asp:TextBox ID="txtGhiChu" runat="server" Height="25px" Width="98%"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;
                        </td>
        ...
        <fieldset>
            ...
            <telerik:RadGrid ID="RG" Width="100%" runat="server" AutoGenerateColumns="False"
                CellSpacing="0" GridLines="None" AllowPaging="True" AllowFilteringByColumn="false"
