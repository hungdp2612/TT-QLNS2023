...
public partial class Chuongtrinh_KeHoachNganSach_XemXet_Test : clsPhanQuyenCaoCap
{
    clsObj Obj;
    ...
    void FTEST()
    {
        //if (TxtMaDV.Text == "KDND")
        //{
        //    RadGDNganSach2.Columns[2].Visible = true;
        //    RadGDNganSach2.Columns[3].Visible = false;
        //    RadGDNganSach2.GroupingEnabled = true;
        //}
        //else
        //{
        //    RadGDNganSach2.Columns[2].Visible = false;
        //    if (TxtMaDV.Text == "P.CU" || TxtMaDV.Text == "P.HCQT")
        //    {
        //        RadGDNganSach2.Columns[3].Visible = true;
        //        RadGDNganSach2.GroupingEnabled = true;
        //    }
        //    else
        //    {
        //        RadGDNganSach2.Columns[3].Visible = false;
        //        RadGDNganSach2.GroupingEnabled = false;
        //    }
        //}
        Obj = new clsObj();
        Obj.Parameter = new string[] { "@Nam", "@MaDV", "@Qui" };
        Obj.ValueParameter = new object[] { rnNam.Text, TxtMaDV.Text, rnQui.Text };
        Obj.SpName = "sp_KeHoachNganSach_TestGrid";
        Sql.fGetData(Obj);
        RadGDNganSach2.DataSource = Obj.Dt;
        RadGDNganSach2.DataBind();
    }
    #endregion
}