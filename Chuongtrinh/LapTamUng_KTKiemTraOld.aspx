<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true"
    CodeFile="LapTamUng_KTKiemTraOld.aspx.cs" Inherits="Chuongtrinh_LapTamUng_KTKiemTraOld" %>
            ...
            <center>
                <table>
                    <tr>
                        ...
                        <td align="left">
                            <telerik:RadNumericTextBox ID="rnNam" runat="server" Width="70px" AutoPostBack="True" Enabled="true"
                        ...
                        <td align="left">
                            <telerik:RadComboBox ID="CboMaDV" runat="server" AllowCustomText="true" AutoPostBack="True"
                                DataValueField="IDMaDV" DataTextField="TenDonVi" Enabled="True" Filter="Contains" Height="200px"
                                MarkFirstMatch="true" Skin="Windows7" Width="220px" OnSelectedIndexChanged="CboMaDV_SelectedIndexChanged">
                            </telerik:RadComboBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtKeToan" Width="215px" Enabled="false" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                     <tr>
                    <td>
            ...
            <div style="float: left; width: 975px;">
                <fieldset style="width: 975px">
                    ...
                    <telerik:RadGrid ID="RGNganSach" Width="975px" Height="200px" runat="server" AutoGenerateColumns="False"
                        ...
                        onpagesizechanged="RGNganSach_PageSizeChanged" PageSize="50">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="SoTien" FilterControlAltText="Filter SoTien column"
                                  ...
                                  <telerik:GridBoundColumn DataField="NSBS" FilterControlAltText="Filter NSBS column"
                                    HeaderText="BSNS" ReadOnly="True" SortExpression="NSBS" UniqueName="NSBS"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                    DataFormatString="{0:###,###.##}" AllowFiltering="false" Aggregate="Sum">
                                       <FooterStyle Font-Bold="True" ForeColor="Blue" HorizontalAlign="Right" />
                                    <HeaderStyle Width="50px" HorizontalAlign="Right" VerticalAlign="Middle" />
                                 ...
                                 <telerik:GridBoundColumn DataField="SumNS" FilterControlAltText="Filter SumNS column"
                                    HeaderText="SumNS" ReadOnly="True" SortExpression="SumNS" UniqueName="SumNS"
                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                    DataFormatString="{0:###,###.##}" AllowFiltering="false" Aggregate="Sum">
                                       <FooterStyle Font-Bold="True" ForeColor="Blue" HorizontalAlign="Right" />
                                    <HeaderStyle Width="50px" HorizontalAlign="Right" VerticalAlign="Middle" />
