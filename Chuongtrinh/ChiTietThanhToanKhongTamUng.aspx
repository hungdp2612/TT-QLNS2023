<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChiTietThanhToanKhongTamUng.aspx.cs"
    Inherits="ChiTietThanhToanKhongTamUng" %>
...
<body>
   ...
   <%-- <script type="text/javascript" defer="defer" language="javascript">
        function onkeyupEvent() {
            ...
            rdThanhTien = rnSoLuong * rnDonGia;
            ...
            InputNganSachConLai.set_value(rnNganSachConLai.get_value() - rdThanhTien.get_value() * rnTiGia.get_value());
            ...
            <ContentTemplate>
                    ...
                    <center>
                        <table cellpadding="2" cellspacing="2">
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtLoaiTien" runat="server" Enabled="False" Width="155px" Skin="Windows7"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <telerik:RadNumericTextBox ID="rnNganSachConLai" Enabled="false" runat="server" AutoPostBack="false"
                                        Skin="Windows7" Width="160px" Value="0">
                                    </telerik:RadNumericTextBox>
                                </td>
                                <td>
                                    &nbsp;
                                ...
                                <td align="left">
                                    <telerik:RadNumericTextBox ID="rdThanhTien"  Enabled="true"  runat="server" Width="160px"
                                        Skin="Windows7" Value="0" ><%-- onkeyup="onkeyupEvent()"--%> <%--11/10/2019--%>
                                    </telerik:RadNumericTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <telerik:RadNumericTextBox ID="rnSoLuong" runat="server"  AutoPostBack="true" OnTextChanged="rdThanhTien_TextChanged" Width="160px" Enabled="true"
                                        Skin="Windows7" Value="0" > <%--onkeyup="onkeyupEvent2()"--%> <%--11/10/2019--%>
                                    </telerik:RadNumericTextBox>
                                </td>
                                <td>
                                    &nbsp;
                                ...
                                <td align="left">
                                    <telerik:RadNumericTextBox ID="rnDonGia" runat="server"  AutoPostBack="true" OnTextChanged="rdThanhTien_TextChanged" Width="160px" Enabled="true"
                                        Skin="Windows7" Value="0" > <%--onkeyup="onkeyupEvent2()"--%> <%--11/10/2019--%>
                                    </telerik:RadNumericTextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtDVT" runat="server" Enabled="true" Width="160px" Skin="Windows7"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtSoHoaDon" runat="server" Enabled="true" Width="155px" Skin="Windows7"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            </tr>
                            <tr>
                                ...
                                <td align="left" colspan="10">
                                    <asp:TextBox ID="txtGhiChu" runat="server" Width="98%" Height="25px" Skin="Windows7"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                ...
                <fieldset>
                    ...
                    <telerik:RadGrid ID="RG" Width="100%" runat="server" AutoGenerateColumns="False"
                        Skin="Windows7" CellSpacing="0" GridLines="None" AllowPaging="True" AllowFilteringByColumn="false"
                        ...
                        <MasterTableView>
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="SỐ HÓA ĐƠN" UniqueName="SoHoaDon" DataField="SoHoaDon"
                                    ...
                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                </telerik:GridBoundColumn> <%--Tâm sửa mới 03/10/2019 AutoPostBackOnFilter="true",ShowFilterIcon="true",Visible="true"--%>
                                ...
                                <telerik:GridBoundColumn HeaderText="SỐ LƯỢNG" UniqueName="SoLuong" DataField="SoLuong"
                                    FilterControlWidth="70px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                    DataFormatString="{0:###,###.##}" AutoPostBackOnFilter="true" AllowFiltering="false">
                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                </telerik:GridBoundColumn>
