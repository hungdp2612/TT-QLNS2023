<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true"
    CodeFile="KeHoachNganSach_XemXet_bak.aspx.cs" Inherits="Chuongtrinh_KeHoachNganSach_XemXet" %>
                ...
                <table width="100%" style="border-collapse: collapse; table-layout: fixed;" cellpadding="0"
                    ...
                    <tr>
                        <td style="vertical-align: top; width: 50%;">
                            <fieldset>
                                <legend style="text-align: center; text-transform: uppercase">Chi phí thực hiện
                                </legend>
                        ...
                        <td style="vertical-align: top; width: 50%;">
                            <fieldset>
                                <legend style="text-align: center; text-transform: uppercase">Kế hoạch ngân sách
                                </legend>
                                <table width="100%" style="border-collapse: collapse; table-layout: fixed;" cellpadding="0"
                                    cellspacing="0">
                                    <tr>
